 ...
 */
export declare function toClientEvmSigner(signer: ClientEvmSigner): ClientEvmSigner;
/**
 ...
 */
export declare function toFacilitatorEvmSigner(client: FacilitatorEvmSigner): FacilitatorEvmSigner;
